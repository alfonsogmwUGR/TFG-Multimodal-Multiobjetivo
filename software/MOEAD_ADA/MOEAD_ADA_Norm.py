...
class MOEAD_ADA_Norm(MOEAD_ADA):
...
###############################################################################
	...
	def run(self, max_evals):
		...
		while self._evals < max_evals:
			...
			print(norm_f_u)
			print("---")
			k = random.randint(0,self._population_size-1)
			print("i: {}".format(k))
			print(norm_FV[k])
			print(self.normalize_vector(self._FV[k]))
			print(np.array_equal(norm_FV[k], self.normalize_vector(self._FV[k])))
			print("---")
			print("Norm z worst")
			print(self.normalize_vector(self._z_worst))
			print("---")
			"""
			...
			print("Neighborhood")
			print(u_neigborhood)
			print(u_distances[u_neigborhood])
			print(self._population[u_neigborhood])
			"""
